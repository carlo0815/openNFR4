...
do_compile_append_gb7252() {
    rm ${S}/${sysconfdir}/opkg/${MACHINE_ARCH}-feed.conf
    echo "src/gz ${DISTRO_FEED_PREFIX}-${feed} ${DISTRO_FEED_URI}/cortexagb7252/${MACHINE_ARCH}" > ${S}/${sysconfdir}/opkg/${MACHINE_ARCH}-feed.conf
}
